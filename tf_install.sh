...
pip3 install --ignore-installed --upgrade tensorflow==1.9 -y
pip3 install -y pillow==5.4.1 lxml==4.3.1 jupyter==1.0.0 matplotlib==3.0.2 opencv-python
...
sudo export PYTHONPATH=$PYTHONPATH:/TensorFlow/models/research/object_detection
sudo export PYTHONPATH=$PYTHONPATH:/TensorFlow/models/research:/TensorFlow/models/research/slim
sudo source ~/.bashrc
